...
@ToString
@Builder
@Table(name = "useroperatationlog")
public class UserOperatationLog extends BasePojo  {
    ...
    @Column(name = "paramters",type = MySqlTypeConstant.VARCHAR, length = 200)
    ...
    public UserOperatationLog(Integer id, Integer userid, String uri, String paramters, Integer operationtype, Date inserttime, Integer moduleid, Integer permissionvalue, String description) {
        this.id = id;
        this.userid = userid;
        this.uri = uri;
